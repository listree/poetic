 ...
 * Description: https://leetcode.com/problems/split-array-into-fibonacci-sequence/
 ...
 */
public class M842SplitIntoFibonacci {

    public final static void main(String[] args) {
        M842SplitIntoFibonacci tester = new M842SplitIntoFibonacci();
    ...
    Memory Usage: 114.6 MB, less than 5.19% of Java online submissions for Split Array into Fibonacci Sequence.
     */
    public List<Integer> splitIntoFibonacci(String num) {
        ...
        for(int i = 1;  i <= imax; i++) { // num starts with '0'
            ...
            for( int j = i + 1; j <= jmax; j++ ) {
                ...
                try {
                    //Check [0, i), [i, j), [j to n is in fibonacci-style
