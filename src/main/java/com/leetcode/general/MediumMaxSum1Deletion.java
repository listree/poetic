 ...
 * Question 1186. Maximum Subarray Sum with One Deletion (Medium)
 * Runtime: 3 ms, faster than 82.66% of Java online submissions for Maximum Subarray Sum with One Deletion.
 * Memory: 47.3 MB, less than 33.78% of Java online submissions for Maximum Subarray Sum with One Deletion.
 */
public class MediumMaxSum1Deletion {
