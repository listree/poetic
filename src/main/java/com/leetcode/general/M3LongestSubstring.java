...
public class M3LongestSubstring {
    public final static void main(String[] args) {
        ...
        M3LongestSubstring tester = new M3LongestSubstring();
        // Example 1:
        // Input: "abcabcbb"
        // Output: 3
    ...
    Memory Usage: 46.7 MB, less than 5.13% of Java online submissions for Longest Substring Without Repeating Characters.
     */
